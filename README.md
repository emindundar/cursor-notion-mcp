...
Terminali açın ve projeyi klonladığınız klasöre gidin:

```bash
cd /path/to/cursor-notion-mcp
```

> **💡 Not:** `/path/to/` kısmını projeyi indirdiğiniz gerçek yol ile değiştirin.
> Örnek: `cd ~/Documents/cursor-notion-mcp`
...
> **⚠️ ÖNEMLİ:** 
> - `/FULL/PATH/TO/PROJECT/` kısmını projenizin **gerçek tam yolu** ile değiştirin
> - `command` kısmında **sanal ortamın Python'unu** kullanın (tam yol)
> - Proje klasöründeyken terminale `pwd` (macOS/Linux) veya `cd` (Windows) yazarak tam yolu öğrenebilirsiniz
> 
> **Örnek yollar:**
> - macOS/Linux: `/Users/kullanici_adi/Documents/cursor-notion-mcp/venv/bin/python`
> - Windows: `C:\\Users\\kullanici_adi\\Documents\\cursor-notion-mcp\\venv\\Scripts\\python.exe`
